...
class AppointmentBookingSettings(Document):
	...
	def validate_availability_of_slots(self) -> None:
	...
	def validate_from_and_to_time(self, from_time, to_time, record) -> None:
	...
	def duration_is_divisible(self, from_time, to_time) -> None:
